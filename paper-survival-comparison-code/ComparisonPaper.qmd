...
```{r fig-featuregrid, fig.width=14, fig.height=8, dpi=400, fig.cap="Significant-feature grids (no LRA)", fig.path="figures/"}
...
```{r fig-featuregrid2, fig.width=14, fig.height=8, dpi=400, fig.cap="Significant-feature grids (only LRA)", fig.path="figures/"}
# B) LRA-ONLY
...
```{r fig-jaccard, fig.width=10, fig.height=6, dpi=300, fig.cap="Jaccard index", fig.path="figures/"}
...
```{r fig-time, fig.width=10, fig.height=6, dpi=300, fig.cap="Timings", fig.path="figures/"}
...
```{r fig-km, fig.width=14, fig.height=8, dpi=360, fig.cap="Kaplan-Meier", fig.path="figures/"}
